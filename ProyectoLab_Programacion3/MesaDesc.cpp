...
void MesaDesc::LoadButtons()
{
	...
	Answers[1][0] = "Hipotesis.";
	Answers[1][1] = "Deduccion.";
	Answers[1][2] = "Evidencia.";
	Answers[1][3] = "Inducción.";

	Answers[2][0] = "Los sentidos son una fuente confiable.";
	Answers[2][1] = "Desconfianza de los sentidos";
